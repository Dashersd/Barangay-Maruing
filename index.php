...
<body>
    ...
    <main>
        ...
        <!-- Home Info Showcase Section -->
        <section class="home-showcase-section">
            <div class="container">
                <div class="showcase-cards-grid">
                    <!-- Column 1: About Barangay Maruing -->
                    <div class="showcase-card showcase-about-card">
                        <div class="showcase-card-header text-left">
                            <h3 class="showcase-card-title text-pink">About Barangay Maruing</h3>
                            <div class="title-accent-bar accent-pink accent-left"></div>
                        </div>
                        <div class="about-card-body">
                            <div class="about-image-col">
                                <img src="public/image/barangay-maruing-cover.png" alt="Barangay Maruing Landscape"
                                    class="about-card-img">
                            </div>
                            <div class="about-info-col">
                                <p class="about-card-text">
                                    Barangay Maruing is a peaceful and progressive community committed to providing
                                    quality public service, maintaining peace and order, and promoting the welfare of
                                    every resident.
                                </p>
                                <a href="about.php" class="btn-showcase btn-pink">Learn More</a>
                            </div>
                        </div>
                    </div>

                    <!-- Column 2: Barangay Leadership -->
                    <div class="showcase-card showcase-leadership-card">
                        <div class="showcase-card-header text-center">
                            <h3 class="showcase-card-title text-purple">Barangay Leadership</h3>
                            <div class="title-accent-bar accent-purple accent-center"></div>
                        </div>
                            ...
                            <div class="leadership-panel">
                                <div class="leadership-item">
                                    ...
                                    <div class="leadership-info">
                                        <h4 class="leadership-title">Punong Barangay</h4>
                                        <div class="leadership-meta">Head of Barangay Governance</div>
                                        <p class="leadership-desc">Leading community development, peace, and public service.</p>
                                    </div>
                                </div>
                                ...
                                <div class="leadership-item">
                                    <div class="leadership-badge council-badge">
                                        <i class="bi bi-people-fill"></i>
                                    </div>
                                    <div class="leadership-info">
                                        <h4 class="leadership-title">Sangguniang Barangay</h4>
                                        <div class="leadership-meta">Barangay Kagawads & SK Council</div>
                                        <p class="leadership-desc">Working collaboratively for legislative and community programs.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="showcase-card-footer text-center">
                            <a href="officials.php" class="btn-showcase btn-purple">Meet Our Officials</a>
                        </div>
                    </div>

                    <!-- Column 3: Contact Us -->
                    <div class="showcase-card showcase-contact-card">
                        <div class="showcase-card-header text-center">
                            <h3 class="showcase-card-title text-pink">Contact Us</h3>
                            <div class="title-accent-bar accent-pink accent-center"></div>
                        </div>
                        <div class="contact-card-body">
                            <div class="contact-details-col">
                                <div class="contact-item">
                                    <i class="bi bi-geo-alt-fill contact-icon-pink"></i>
                                    <div class="contact-text">
                                        <strong class="contact-name">Barangay Maruing</strong>
                                        <span class="contact-sub">Maruing, Municipality</span>
                                    </div>
                                </div>
                                <div class="contact-item">
                                    <i class="bi bi-telephone-fill contact-icon-pink"></i>
                                    <div class="contact-text">
                                        <span class="contact-phone">09XX-XXX-XXXX</span>
                                    </div>
                                </div>
                                <div class="contact-item">
                                    <i class="bi bi-clock-fill contact-icon-pink"></i>
                                    <div class="contact-text">
                                        <span class="contact-days">Monday - Friday</span>
                                        <span class="contact-time">8:00 AM - 5:00 PM</span>
                                    </div>
                                </div>
                                <a href="spot-map.php" class="btn-showcase btn-pink btn-map">
                                    <i class="bi bi-geo-alt-fill"></i> See Map
                                </a>
                            </div>
                        </div>
                    </div>
